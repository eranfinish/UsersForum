...
using UsersForum.Core.Users;
using UsersForum.Core.Utils;
using entities = UsersForum.DAL.Entities;
using repos = UsersForum.DAL.Repositories;



namespace UsersForum.API.Controllers
{
    ...
    public class UserController : ControllerBase
    {
     private readonly IUtilsService _utils;
        ...
        [HttpPost("register")]
        public async Task<IActionResult> Register([FromBody] UsersForum.Core.Models.User usr)
        {
            try
            {
        ...
        private JwtSecurityToken GenerateJWT(UsersForum.Core.Models.User usr)
        {
            usr.Name = usr.Name ?? "";
        ...
        public IActionResult Login(UserLogin userLogin)
        {
            try
            {
                ...
                var usr = new UsersForum.Core.Models.User();
        ...
        //[Authorize]
        [HttpGet("Logout")]
        public IActionResult Logout(UsersForum.Core.Models.User user)
        {
            try
            {
