...
using System.Text;
using UsersForum.DAL;
using UsersForum.DAL.Repositories.Posts;
using UsersForum.DAL.Repositories.Responses;
using UsersForum.DAL.Repositories.Users;
using UsersForum.Core.Helpres;
using UsersForum.Core.Utils;
using UsersForum.API.signalR;
using UsersForum.API.Validations;
using services = UsersForum.Core;
